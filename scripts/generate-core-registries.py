...
tests = [
    ...
    ("AT-M7-COMPETITOR-COVERAGE", "M7", "Every adopted competitor capability is core or an installable official pack with an evaluation.", "python scripts/verify-packs.py plus live connector evaluations", "mixed", "in_progress"),
    ...
    ("AT-M9-SECURITY", "M9", "No critical/high finding remains; SBOM, licenses, provenance, fuzzing, and red-team reports are complete.", "python scripts/security-gate.py plus Security workflow", "mixed", "in_progress"),
]
...
cap_specs = [
    ...
    ("CAP-CONNECTORS","connectors","Official productivity, communications, development, smart-home, media, cloud, travel, shopping, and creative packs.", ["ChatGPT","Claude","Gemini","Alexa+","Home Assistant"], "new", "official-pack", "M7", ["AT-M7-COMPETITOR-COVERAGE"], "in_progress"),
    ("CAP-RESEARCH","research","Cited multi-source research, contradiction reporting, saved projects, structured extraction, and source provenance.", ["ChatGPT","Perplexity","Gemini","Claude"], "new", "core", "M7", ["AT-M7-COMPETITOR-COVERAGE"], "in_progress"),
