...
tests = [
    ...
    ("AT-M2-NATIVE-TOOL-BRIDGE", "M2", "The sidecar plugin can invoke only an authenticated, registered-session-scoped native tool; rejected tokens/scopes are unaudited and an accepted call traverses policy, filtering, verification, and audit.", "cargo test -p personal-agent-runtime native_tool_bridge_requires_authentication_and_registered_session_scope && cargo test -p personal-agent-runtime isolated_sidecar_streams_a_synthetic_provider_tool_turn", "automated", "passed"),
